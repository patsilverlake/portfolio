export default function Page() {
  return (
    <section>
      ...
      <p className="mb-4">
        {`As a casual, 
        I found the most recent developments in AI to be the spark that reignited my drive to build practical,
         impactful tools for personal productivity and potentially for nimble, high-performing teams.`}
      </p>
      <p className="mb-8">
        {`That spark came during my studies at CBS, where Professor Daniel Guetta's courses gave me the analytical and statistical framework to understand machine learning models. Though my background is rooted in finance, AI has inspired me to build tools that optimize my daily workflow and brainstorm strategies with businesses—whether it's an AI-driven analytics MVP or a product idea to streamline operations. Using tools like Cursor, Vercel, Supabase, and more, I've been developing solutions that blend my investment expertise with a hands-on approach to technology, and this portfolio showcases that journey.`}
      </p>
